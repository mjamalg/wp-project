...
![wp-project jpg](https://github.com/user-attachments/assets/3ed8a7e9-064d-409a-b17a-a5b12ed4f1ad)
...
- **In eks-ansible**
    ...
    - _roles/eks-addon-config/_
        - files/external-dns-sa-config.yml:
            - Chage the external-dns image version to the latest if desired. v0.15.0 was the latest at the time of publishing. You can find the latest version here: ![ExternalDNS](https://github.com/kubernetes-sigs/external-dns/)      
        ...
        - defaults/main.yml:
            - Change "cert_manager_helm_chart_version" to the desired version. 1.15.3 was the latest at the time of publishing. You can find the lastest version here: ![cert-manager](https://cert-manager.io/) 
